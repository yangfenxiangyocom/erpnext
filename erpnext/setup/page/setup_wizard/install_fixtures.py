...
def install(country=None):
	records = [
		...
		{'doctype': 'Item Group', 'item_group_name': _('Products'),
			'is_group': 'No', 'parent_item_group': _('All Item Groups'), "show_in_website": 1,"page_name":'products' },
		{'doctype': 'Item Group', 'item_group_name': _('Raw Material'),
			'is_group': 'No', 'parent_item_group': _('All Item Groups') ,"page_name":'raw_material' },
		{'doctype': 'Item Group', 'item_group_name': _('Services'),
			'is_group': 'No', 'parent_item_group': _('All Item Groups') ,"page_name":'service'  },
		{'doctype': 'Item Group', 'item_group_name': _('Sub Assemblies'),
			'is_group': 'No', 'parent_item_group': _('All Item Groups') ,"page_name":'sub_assemlies' },
		{'doctype': 'Item Group', 'item_group_name': _('Consumable'),
			'is_group': 'No', 'parent_item_group': _('All Item Groups') ,"page_name":'consumable'  },
